...
> Authoring prerequisite — complete automatically before production: follow `_engine/sops/Ad-Editing-Plan-First-SOP.md`; save the concept's editing plan and reference cut evidence. Fill this brief's edit rules and visual schedule from that plan. Record plan version, provisional timing and asset gaps; update on revisions. Do not wait for Brooks to request an editing plan. Keep this authoring instruction out of the final external brief.
