...
Database event through: **71** · 13 creative records. See `sync-state.json` for last successful sync/error details. On a read-only remote mirror, confirm snapshot freshness before assuming it is current.

## Brands

- [[_engine/ad-system/data/memory/brands/motilli|Motilli]] · 11 creatives
- [[_engine/ad-system/data/memory/brands/velantra|Velantra]] · 2 creatives

## Performance evidence

0 imported measurement rows; 2 registered exports; 0 exact platform ad mappings. Counts do not imply winning ads or statistical sufficiency.
