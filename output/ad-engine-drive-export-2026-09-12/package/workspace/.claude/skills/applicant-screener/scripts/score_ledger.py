...
Claude judges. This script adds up, applies the gates and caps, decides the
verdict, and writes the two files that matter: a report a human can audit and
an action queue the browser step executes.
...
Commands
  init   --run DIR --brand velantra|motilli [--job-url URL] [--job-title T]
...
# Weighted toward the three things Brooks named: the right visual under the
# right line, fast pacing, and a reel that resembles the Balmbare benchmark.
...
WEIGHTS = {
    ...
    "benchmark_resemblance": 1.5,  # reads like Balmbare-class DR, not a brand film
    "category_fit":          1.5,  # fashion+apparel (Velantra) / supplement DR (Motilli)
...
BRANDS = {
    "velantra": {"filter_word": "SAFFRON", "category": "fashion / apparel",
                 "posting": "_engine/business/hiring/video-editor-job-posting-CLEAN.md"},
    "motilli":  {"filter_word": "JUNIPER", "category": "supplement / health / wellness DR",
                 "posting": "_engine/business/hiring/motilli-video-editor-job-posting-CLEAN.md"},
}
