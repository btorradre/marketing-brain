...
SHOTS = {
    "B01-closet": (["LC-01.png"], CLOSED,
        ...
        "shoebox, a straw tote pushed to the back. Light comes only from a bedroom window off to the "
    ...
    "B02-flatlay": (["LC-01.png"], CLOSED,
        ...
        "are scattered above it, not arranged: a small folded wallet, a set of keys on a ring, a lip "
        "balm, a pair of sunglasses lying open. Her other hand rests in the corner of the frame. "
