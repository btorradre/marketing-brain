...
BEATS = {
 ...
 "margot": [
  ...
  ("B03", "This is the Meridian", f"{MAR}/VEL-MAR-030-cafe-marble-still.png", "Brown tote on the marble cafe table, front three-quarter. Hold clean on the name.", "product intro", "This is the Meridian from Velantra."),
