...
PRODUCTS = {
 ...
 "weekender": {
   ...
   "shots": {
     ...
     "EURO-P2": ("p009", "She carries the weekend bag by its two rolled handles in the hand that is free, at her side, reaching from her hip toward her knee and as wide as her shoulders; the coffee stays in her other hand. Long coat, crosswalk, the Paris street exactly as the first photo. "),
     ...
     "EURO-L1": ("p078", "She carries the weekend bag by its two rolled handles in her hand at her side, reaching from her hip toward her knee and as wide as her shoulders; houndstooth blazer, tall boots and the London street exactly as the first photo. "),
   }},
 "margot": {
