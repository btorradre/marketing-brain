...
sections = {
    'opening': campaign('VELANTRA', 'A Life Well Carried', 'vivienne-steps-v2',
        is_hero=True, image_alt='A woman seated on limestone steps with the Chocolate Vivienne in soft natural daylight',
        ...
        alignment='left',mobile_position='50% 50%',mobile_image_url=urls['heritage-vivienne-steps-v2-mobile'],shade=55),
