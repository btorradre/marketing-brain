...
SCRIPT = Path.home() / 'Library/Application Support/Blackmagic Design/DaVinci Resolve/Fusion/Scripts/Utility/velantra_build.lua'
...
click menu item "velantra_build" of menu 1 of menu item "Scripts" of menu "Workspace" of menu bar 1
end tell'''
