...
O=Path(__file__).resolve().parent;Q=O/'qa';Q.mkdir(exist_ok=True);V=O/'deliverables/Motilli-Unbranded-VSL-v15.mp4';old=O.parent/'production-v12/deliverables/Motilli-Unbranded-VSL-v12.mp4'
...
frames=[0,1,48,96,97,98,1424,1425,1458,1490,1491,7255,7256,7301,7345,7346]
for f in frames:subprocess.run(['ffmpeg','-v','error','-y','-ss',f'{f/30:.9f}','-i',str(V),'-frames:v','1','-q:v','2',str(Q/f'frame-{f}.jpg')],check=True)
im=Image.new('RGB',(1200,2220),'#eee');d=ImageDraw.Draw(im)
