...
O=pathlib.Path(__file__).resolve().parent;G=O/'graphics-lock';G.mkdir(exist_ok=True);caps=json.loads((O/'caption-cues.json').read_text());font=ImageFont.truetype('/System/Library/Fonts/Supplemental/Arial Bold.ttf',52)
jobs=[]
for c in caps:
