...
def work(h):
 f=O/f'sources/{h}-default-speed.mp3' if phase=='source' else O/f'deliverables/Motilli-V26-{h}-Woman-Over-40-Natural-Resolve-1.2x.mp3';out=O/f'qa/{h}-{phase}-scribe.json'
 if not out.exists():
