#!/usr/bin/env python3
"""Deploy the Motilli GLP-1 "stuck" advertorial to Shopify (LIVE getmotilli.com).
...
PAGE_HANDLE = "stuck-on-your-glp1"
PAGE_TITLE = "Stuck on Your GLP-1? Bloated, Burping, and Going Days Without?"
...
ASSETS = [
    ("linda_k.png", "image"),
    ("mechanism_split.jpg", "image"),
    ("motilli_jar.png", "image"),
    ("relief_family.jpg", "image"),
    ("problem_receipt.jpg", "image"),
    ("gut_hero.jpg", "image"),
    ("what_works.jpg", "image"),
    ("benefit_card.jpg", "image"),
    ("dont_quit.jpg", "image"),
]
