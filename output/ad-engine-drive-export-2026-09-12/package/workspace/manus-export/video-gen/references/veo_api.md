...
Background notes for debugging or extending `scripts/generate_video.py`. Models and endpoints evolve — if a call starts failing, re-check Google's current Gemini API video-generation documentation.
