# Vivienne Top Handle Bag — Locked Verbatim Prompt Blocks

These blocks are locked text. Paste each one into every generation prompt exactly as written, in the situations it specifies — do not paraphrase, summarize, or reword them, even slightly. See `../SKILL.md` for the product identity summary, colorways, and open items.
