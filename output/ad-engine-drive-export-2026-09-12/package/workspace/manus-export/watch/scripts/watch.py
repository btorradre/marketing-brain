...
Prints a markdown report to stdout listing frame paths + transcript. Read each
frame path afterward to see the video.
"""
...
def main() -> int:
    ...
    print()
    print(
        "**View each frame path below to see the image.** "
