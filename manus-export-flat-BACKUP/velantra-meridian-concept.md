...
Use this when you need to write a video ad concept and creative brief for the Velantra Meridian — a structured leather-look everyday handbag/tote positioned as durable professional carry. Trigger on requests like "video ad concept for the meridian," "write a meridian ad," "new video ad for the meridian," or any ad concepting/briefing request for this specific product. Pair with the Meridian product-scale document above for the actual visual/colorway details when it's time to generate imagery.
...
6. Once the concept is approved, hand it off to production using the Meridian product-scale reference material above for accurate product generation.
