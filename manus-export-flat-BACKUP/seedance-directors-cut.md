...
This document does not define exact prompt syntax for any specific video model — that's a separate, model-specific reference. This document governs how to read a reference, redirect it, cut it into scenes, and QA it.
