...
If the CLI returns `Unknown params: hook_id` or `Unknown params: setting_id`, do not retry with that flag for the selected model; its schema does not support setup items.
