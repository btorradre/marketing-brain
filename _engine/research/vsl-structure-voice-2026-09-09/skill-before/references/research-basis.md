...
The original workspace artifacts are under `_engine/research/trendtrack-ai-ugc-vsls-2026-09-06/`: `AI-UGC-VSL-BREAKDOWN.md`, `evidence-gallery.html`, `evidence-index.json`, and `coverage.json`. They are optional provenance, not dependencies for using this skill. This reference preserves the main lessons and source links without an API connection.
