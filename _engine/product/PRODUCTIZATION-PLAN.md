...
September 13, 2026: this is a historical plan. The current proposed architecture is [Ecommerce creative harness: GPT-6 overseer and specialist agents](ECOMMERCE-AGENT-HARNESS-PLAN.md). It replaces the customer-Claude and browser-editor direction below with GPT-6 oversight, tenant-scoped specialist workflows and DaVinci Resolve execution. Historical implementation/status statements have not been reverified by this notice.
