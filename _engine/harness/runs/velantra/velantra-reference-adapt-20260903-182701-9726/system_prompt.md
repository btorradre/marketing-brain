...
# This run
- run id: velantra-reference-adapt-20260903-182701-9726
- workflow: reference-adapt
- brand: velantra
- product: weekender
- run directory (write report.md and any working files here): /Users/brooksorradre2/Documents/marketing brain/_engine/harness/runs/velantra/velantra-reference-adapt-20260903-182701-9726
...
## Ending the run
When the stop artifact exists, write `/Users/brooksorradre2/Documents/marketing brain/_engine/harness/runs/velantra/velantra-reference-adapt-20260903-182701-9726/report.md` with these sections:
