...
## Hook Catalog (snapshot — May 2026)
...
## Setting Catalog (snapshot — May 2026)
...
- Setting = Volcano Rim + Brand = Lunessa: bad fit, kills trust.
- Setting = Volcano Rim + Brand = energy drink with "extreme durability" angle: great fit; reference the volcano in the script.
- Setting = Kitchen + Brand = Motilli: natural fit; have the avatar reach for the gummies between food prep.
