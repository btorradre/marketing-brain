local ad={[ [=[name]=] ]=[=[VEL-OM-H1-A2-R3]=],[ [=[id]=] ]=[=[VEL-OM-H1-A2]=],[ [=[hook]=] ]=[=[H1]=],[ [=[avatar]=] ]=[=[A2]=],[ [=[otio]=] ]=[=[/Users/brooksorradre2/Documents/marketing brain/brands/velantra/creative/old-money-look-2026-09-10/production/revision-3/resolve/VEL-OM-H1-A2-R3.otio]=],[ [=[duration_frames]=] ]=1539,[ [=[green]=] ]={0.0392156862745098,0.6823529411764706,0.18823529411764706},[ [=[overlay_clips]=] ]=11,[ [=[final_hold_frames]=] ]=4,[ [=[captions]=] ]={{[ [=[in]=] ]=0,[ [=[out]=] ]=83,[ [=[text]=] ]=[=[Everyone wants that old money
