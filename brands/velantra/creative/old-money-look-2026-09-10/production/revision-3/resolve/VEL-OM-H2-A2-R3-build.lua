local ad={[ [=[name]=] ]=[=[VEL-OM-H2-A2-R3]=],[ [=[id]=] ]=[=[VEL-OM-H2-A2]=],[ [=[hook]=] ]=[=[H2]=],[ [=[avatar]=] ]=[=[A2]=],[ [=[otio]=] ]=[=[/Users/brooksorradre2/Documents/marketing brain/brands/velantra/creative/old-money-look-2026-09-10/production/revision-3/resolve/VEL-OM-H2-A2-R3.otio]=],[ [=[duration_frames]=] ]=1644,[ [=[green]=] ]={0.0392156862745098,0.6823529411764706,0.1843137254901961},[ [=[overlay_clips]=] ]=10,[ [=[final_hold_frames]=] ]=3,[ [=[captions]=] ]={{[ [=[in]=] ]=0,[ [=[out]=] ]=74,[ [=[text]=] ]=[=[Before you buy another outfit
