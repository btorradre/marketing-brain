local ad={[ [=[name]=] ]=[=[VEL-OM-H1-A3-R3]=],[ [=[id]=] ]=[=[VEL-OM-H1-A3]=],[ [=[hook]=] ]=[=[H1]=],[ [=[avatar]=] ]=[=[A3]=],[ [=[otio]=] ]=[=[/Users/brooksorradre2/Documents/marketing brain/brands/velantra/creative/old-money-look-2026-09-10/production/revision-3/resolve/VEL-OM-H1-A3-R3.otio]=],[ [=[duration_frames]=] ]=1539,[ [=[green]=] ]={0.07058823529411765,0.5764705882352941,0.21176470588235294},[ [=[overlay_clips]=] ]=11,[ [=[final_hold_frames]=] ]=4,[ [=[captions]=] ]={{[ [=[in]=] ]=0,[ [=[out]=] ]=83,[ [=[text]=] ]=[=[Everyone wants that old money
