...
if mode=='prepare':
 for kind,path in [('image',P/'presenter/P01-green.png'),('audio',P/'voice/narration-native-1.1x.mp3')]:
 ...
 if 'look_id' not in state:
  d=api('POST','/v3/avatars',{'type':'photo','name':'Eleanor Eurotravel P01 Natural110','file':{'type':'asset_id','asset_id':state['image_asset_id']}})
 ...
 payload={'type':'avatar','avatar_id':state['look_id'],'audio_asset_id':state['audio_asset_id'],'engine':{'type':'avatar_v'},'resolution':'1080p','aspect_ratio':'auto','title':'Eleanor European Travel — P01 — Natural 1.1x'}
