...
P=Path(__file__).resolve().parent;R=P/'resolve-gringo';Q=P/'qa-gringo';Q.mkdir(exist_ok=True);v=P/'exports/Weekender-Haaland-Gringo-Natural-AvatarV.mp4';M=json.loads((R/'manifest.json').read_text());S=M['scenes'];C=M['captions'];F=Q/'frames';F.mkdir(exist_ok=True)
def frame(n):
 p=F/f'{n:05d}.png'
