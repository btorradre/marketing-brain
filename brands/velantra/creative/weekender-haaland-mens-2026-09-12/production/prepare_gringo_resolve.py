...
P=Path(__file__).resolve().parent;B=P.parent;R=P/'resolve-gringo';FPS=30
...
name='Weekender-Haaland-Gringo-Natural-AvatarV-v1' if ready else 'Weekender-Haaland-Assembly-WIP'
