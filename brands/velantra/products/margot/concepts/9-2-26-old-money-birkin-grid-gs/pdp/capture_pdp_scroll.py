...
URL  = "https://velantrafashion.com/products/velantra-margot-tote"
FPS, DUR = 30, 5.2
SCROLL_FRAC = 0.72          # scrolling occupies the first 72%, then it holds
Y0, Y1 = 780, 1000           # title+price+swatches -> Add to Cart + description; stops well above the stale laptop-sleeve and brass blocks
