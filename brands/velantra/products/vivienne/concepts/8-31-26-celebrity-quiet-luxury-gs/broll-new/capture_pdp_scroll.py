...
FPS, DUR = 24, 9.70
SCROLL_FRAC = 0.88          # keep it visibly moving; 0.72/0.78 completed the travel by 4s and died
Y0, Y1 = 640, 1085         # price+swatches+ATC -> pre-order / October paragraph settled and held

def ease_out(t):            # decelerate into the hold, no hard stop
    return 1 - (1 - t) ** 2     # gentler than cubic: cubic parked the scroll half way through
