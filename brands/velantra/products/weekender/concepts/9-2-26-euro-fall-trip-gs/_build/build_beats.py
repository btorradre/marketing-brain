...
BEATS = {
 ...
 "weekender": [
  ...
  ("B02b", "and it goes in the overhead", E("BIN-01"), "Her hands lifting the closed bag into the overhead bin, flap down, straps hooked.", "proof: overhead bin", "and it goes in the overhead bin."),
  ("B03", "This is the Eleanor", E("HERO-01"), "Closed bag on the hotel luggage rack, three-quarter, straps hooked, key bell hanging. Hold clean on the name.", "product intro", "This is the Eleanor Weekender from Velantra."),
  ...
  ("B05", "so three days of clothes", E("OPEN-PACK-01"), "Open and packed on the hotel bed: knit, rolled shirt and pouch on the caramel leather lining, flap folded back behind the mouth.", "capacity demo", "so three days of clothes fit in here,"),
  ("B05b", "and the flap folds", E("OPEN-FLAP-01"), "Open and empty on the bench: the one-piece flap leaning back with its inner face and oval plate, caramel interior and slip pocket, post and staples on the plain front band.", "mechanism demo", "and the flap folds all the way back so I can see everything."),
  ...
  ("B07b", "real brass hardware", E("MACRO-01"), "Macro on the marble console: knurled brass post through the oval plate's keyhole, strap plate hooked over the staple. Nothing printed on it.", "hardware, no logo", "real brass hardware, no logo anywhere,"),
  ...
  ("B10", "so the knitwear", E("KNIT-01"), "Her hand pushes a knit down into the open bag on the desk, caramel interior and folded-back flap visible, coat on the chair.", "capacity demo", "so the knitwear and the coat come too, and it still keeps its shape."),
