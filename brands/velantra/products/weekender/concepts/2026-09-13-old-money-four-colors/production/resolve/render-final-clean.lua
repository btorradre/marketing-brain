...
local pm=r:GetProjectManager() local p=pm:GetCurrentProject() assert(p:GetName()=="VEL_Weekender_OldMoney_FourColors_Final_20260913") local t=p:GetCurrentTimeline() assert(t:GetName()=="Weekender-OldMoney-FourColors-Final") assert(not p:IsRenderingInProgress()) assert(t:GetEndFrame()==1539)
