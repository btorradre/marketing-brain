"""
Upload 14 listicle images to the Motilli Shopify store (y9t3s8-ns) and create
the 5-Reasons-Miralax listicle as a published Shopify page.
...
PAGE_HANDLE = "5-reasons-miralax-glp1"
PAGE_TITLE = "5 Reasons Miralax Will Never Fix Your GLP-1 Constipation (And What Actually Works on the Right Organ)"
