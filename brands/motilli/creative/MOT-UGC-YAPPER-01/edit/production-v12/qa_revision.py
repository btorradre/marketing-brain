...
O=Path(__file__).resolve().parent;Q=O/'qa';Q.mkdir(exist_ok=True);V=O/'deliverables/Motilli-Unbranded-VSL-v12.mp4';old=O.parent/'production-v11/deliverables/Motilli-Unbranded-VSL-v11.mp4'
...
frames=[1330,1331,1364,1375,1418,1419]
...
report={'duration_seconds':v['duration'],'frames':8327,'resolution':[1080,1920],'fps':30,'audio_correlation_to_v11':corr,'max_pcm_difference':err,'replacement_frames':[1331,1419],'review_frames':frames,'unchanged_audio_verified':True};(Q/'revision-qa.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2),flush=True)
