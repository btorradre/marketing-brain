...
O=Path(__file__).resolve().parent;Q=O/'qa';Q.mkdir(exist_ok=True);V=O/'deliverables/Motilli-Unbranded-VSL-v13.mp4';old=O.parent/'production-v12/deliverables/Motilli-Unbranded-VSL-v12.mp4'
...
frames=[1424,1425,1440,1458,1480,1490,1491]
