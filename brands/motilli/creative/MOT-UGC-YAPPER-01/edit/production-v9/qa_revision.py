...
O=Path(__file__).resolve().parent;Q=O/'qa';Q.mkdir(exist_ok=True);V=O/'deliverables/Motilli-Unbranded-VSL-v9.mp4';old=O.parent/'production-v8/deliverables/Motilli-Unbranded-VSL-v8.mp4'
...
frames=[4618,4619,4634,4685,4750,4751]
...
im.save(Q/'research-in-context.jpg')
