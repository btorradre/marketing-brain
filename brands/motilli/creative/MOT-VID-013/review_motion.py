...
if __name__=='__main__':
 plan=json.loads((HERE/'production-plan-generated.json').read_text());jobs=[s for s in plan['shots'] if (OUT/(s['id']+'.mp4')).exists()]
 motion=json.loads((HERE/'motion-manifest.json').read_text());by={s['id']:s['motion'] for s in motion['shots']}
